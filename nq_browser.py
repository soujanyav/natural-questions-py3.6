...
python nq_browser.py --nq_jsonl=nq-train-sample.jsonl.gz
python nq_browser.py --nq_jsonl=nq-dev-sample.jsonl.gz --dataset=dev --port=8081
"""
...
class Example(object):
    ...
    def render_span(self, start, end):
        return self.document_html[start:end].decode('utf-8')
...
def main(unused_argv):
    ...
    print("Starting the NQ server now")
